...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        // string output = @"E:\Education\Saxion\Internship\Projects\results\output_batch_job.csv";
        ...
        //     ? $"[run_batch_job] Success in {sw.ElapsedMilliseconds} ms"
        //     : "[run_batch_job] Failed");
    }
}
